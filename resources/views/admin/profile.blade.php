...
<div class="page-title">
  <div class="row">
    ...
    <h2 class="mb-0" style="color:#fff ;text-align:center; padding-top: 10px; padding-bottom: 10px; ">  تعديل البيانات الشخصية </h2>
    </div>
  </div>
</div>
<!-- breadcrumb -->
...
<div class="modal-body" style=" background-color:#175166; padding: 30px; border-radius: 10px;">
                    <form action="{{route('updateTeacher',$data->id)}}" method="post">
                            ...
                            <input type="text" name="name" class="form-control" value="{{$data->name}}" style=" border-radius: 10px;">
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 mb-30">
                            <label style="color:#fff; font-size: 25px; margin-right: 10px;" >رقم التلفون</label>
                            <input type="text" name="password" class="form-control" value="{{$data->phone}}" style=" border-radius: 10px;">
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 mb-30">
                            <label style="color:#fff; font-size: 25px; margin-right: 10px;" >الايميل</label>
                            <input type="email" name="email" class="form-control" value="{{$data->email}}" style=" border-radius: 10px;">
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 mb-30">
        ...
        <div class="row">
             <button type="submit"  style="color:#dc3545 ;text-align:center; background-color: #dc3545; margin:0px auto; border-radius:7px;"> 
                <h4 class="mb-0" style="color:#fff ;text-align:center;padding: 50px; padding-top: 10px; padding-bottom: 10px;  ">  تعديل البيانات الشخصية </h4>
            </button>
            </div>
        </div>
    </div>
