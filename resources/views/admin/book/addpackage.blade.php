    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="content-container">
                <form action="{{ route('postPackageDetails',$package->id) }}" method="POST">
                    @csrf
                            ...
                            <li>
                                <label>
                                    <div class="checkbox-container">
                                        <input type="checkbox" name="selected_subjects[]" value="{{ $book->id }}" data-price="{{ $book->price }}" class="course-checkbox">
                                        {{ $book->name }}
                                    </div>
                                </label>
                            </li>
                            @empty
                            <li>لا توجد مذكرات متاحة حالياً.</li>
                            @endforelse
                        </ul>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="content-container">
                                    <p><strong>عدد المذكرات المحددة:</strong> <span id="selected-count">0</span></p>
                                </div>
                            </div>
                        </div>
                    </div>
...
<!-- Display count of selected books immediately -->
