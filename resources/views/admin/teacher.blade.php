...
<div class="row">
  <div>
    <h2 style="position: absolute; left:10%; top:13%; color:#dc3545"> اجمالي عدد المعلمين ({{$count}})</h2>
  </div>
  <!-- breadcrumb -->
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  <!--  edit Modal -->
                  <div class="modal fade" id="edit{{$teaher->id}}" tabindex="-1" aria-labelledby="exampleModalLabel"
                    aria-hidden="true">
