...
<body>
    <header>
        <nav class="navbar navbar-expand-lg shadow-sm ">
            <div class="container">
                <a class="navbar-brand fw-bold" href="#"><img src="assets/ass/img/logo.png" height="56"
                        alt=""></a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <form class="d-flex" role="search">
                        <a href="{{ route('login') }}" class="btn-20"><span>
                                @guest
                                    تسجيل الدخول
                                @endguest
        ...
        <div class="container h-100">
            <div class="contant  d-flex  justify-content-center align-items-center">
                <div class="text">
                    ...
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquid, ad voluptate. Mollitia labore
                        suscipit vitae recusandae delectus voluptas nobis, praesentium autem, quia quos libero quasi
                        fugiat aliquam eius voluptate voluptatibus.</p>
            ...
            <div class="container py-5">
                <div class="row">
                    <div class="col-lg-6 col-sm-12">
                        ...
                        <p class="fw-bold pt-3">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Excepturi,
                            tempora.</p>
                    </div>
                    <div class="col-lg-6 col-sm-12 justify-content-center">
                        <div class="input-group  mb-5">
                            ...
                            <button class="btn btn-success fw-bold border-rad" type="button"
