...
<div>
    <h2 style="text-align: center; margin: 10px; background-color: #444; padding: 10px; color: #fff; border-radius: 5px;">
        سلة مشترياتك </h2>
</div>
                        ...
                        <div style="display: flex; justify-content: space-around;flex-direction: row;align-items: center">
                            ...
                            <div class="col-lg-3 col-sm-12 mb-4 mb-lg-0">
                                ...
                                <div class="bg-image hover-overlay hover-zoom ripple rounded" data-mdb-ripple-color="light">
                                    <img src="{{ asset('cartImage.jpeg') }}" width="140px" style="border-radius: 10px" alt="image" />
                                </div>
                                <!-- Image -->
                            </div>
                            ...
                            <div class="col-lg-4 text-right col-sm-12 mb-4 mb-lg-0">
                                ...
                                <form action="{{ route('cartDelete', $cart->id) }}" method="post">
                                    @csrf
                                    <button type="submit" style="border: none ; background:none" data-mdb-toggle="tooltip" title="Remove item">
                                        <img src="https://cdn-icons-png.flaticon.com/128/6711/6711573.png" width="40px" />
                                    </button>
                                </form>
                                <!-- Price -->
                            </div>
